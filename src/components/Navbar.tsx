...
export function Navbar({ currentView, onViewChange }: NavbarProps) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-800 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Navigation */}
        <div className="md:hidden border-t border-gray-200 dark:border-gray-800 px-2 py-3">
